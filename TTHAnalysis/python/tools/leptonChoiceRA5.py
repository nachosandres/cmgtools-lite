...
#            self.FR_el = (self.FRfile.Get("FRElPtCorr_ETH_non"),self.FRfile.Get("FRElPtCorr_ETH_iso"))
    ...
    def findPairs(self,leps1,leps2,byflav,bypassMV,choose_SS_else_OS=True,event=None):
        ...
        for p in [(l1,l2) for l1 in leps1 for l2 in leps2 if l1!=l2]:
            if event!=None and event.evt==157039:
                print p[1].pt, p[0].pt
        ...
        for (l1,l2) in _p:
            ...
            if event!=None and event.evt==157039:
                print l1.pt, l2.pt, flav, ht, (l1.charge == l2.charge), choose_SS_else_OS
    ...
    def SR(self, _l1pt, _l2pt, ht, met, nj, nb, mtw,event=None):
        ...
        if event!=None and event.evt==226544:
            print "-> ", l1pt > 25, l2pt > 25, ht < 300, nb == 0, "/ (",ht, met, nj, mtw,") ",  (met > 50 and met < 200 and nj >= 5 and mtw < 120), (met > 200 and met < 300 and nj >= 2 and mtw < 120), (met > 50 and met < 300 and nj >= 2 and mtw > 120)

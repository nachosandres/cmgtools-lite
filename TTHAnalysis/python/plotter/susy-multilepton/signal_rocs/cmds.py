...
publdir = "/afs/cern.ch/user/c/cheidegg/www/heppy/2016-04-29_leptons_nosel" #do NOT give a trailing /
...
if "rocs" in do: 
	...
	bins = [
           [ # denominator = LepGood + loose cuts
	         ...
	         ["mu_pt_25_100" , "cuts_loose", " --xrange 0.001 1.0 --legend TL --yrange 0.6 1.0 -R pt20 pt 'LepGood_pt > 25 && LepGood_pt < 100'"], \
	         ["mu_pt_10_25"  , "cuts_loose", " --xrange 0.001 1.0 --legend TL --yrange 0.4 1.0 -R pt20 pt 'LepGood_pt > 10 && LepGood_pt < 25'" ], \
	...
	plots = [
	        #[0, "ids" , "'mvaTTH,TTHt,RA7t,RA5t,OSt,NROSt' -F sf/t /mnt/t3nfs01/data01/shome/cheidegg/o/2016-03-18_ewktrees/leptonJetReCleanerSusyRA7_good/evVarFriend_{cname}.root -F sf/t /mnt/t3nfs01/data01/shome/cheidegg/o/2016-03-18_ewktrees/leptonJetReCleanerSusyRA5/evVarFriend_{cname}.root -F sf/t /mnt/t3nfs01/data01/shome/cheidegg/o/2016-03-18_ewktrees/LepMVAFriendMoriond16/evVarFriend_{cname}.root"],
